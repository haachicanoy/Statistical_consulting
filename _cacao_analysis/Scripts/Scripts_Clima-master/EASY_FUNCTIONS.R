...
dirFol    <- "D:/Harold/Asesorias/Liliana Moreno/Data/Climate/santander"
...
SUMMARY(dirFol, objeto = "TMAX", YStart, YEnd)
SUMMARY(dirFol, objeto = "TMIN", YStart, YEnd)
SUMMARY(dirFol, objeto = "RAIN", YStart, YEnd)
SUMMARY(dirFol, objeto = "ESOL", YStart, YEnd)
SUMMARY(dirFol, objeto = "RHUM", YStart, YEnd)
